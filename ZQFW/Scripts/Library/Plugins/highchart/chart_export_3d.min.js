...
(function (f) {
    var A = f.Chart, t = f.addEvent, B = f.removeEvent, l = f.createElement, o = f.discardElement, v = f.css, k = f.merge, r = f.each, p = f.extend, D = Math.max, j = document, C = window, E = f.isTouchDevice, F = f.Renderer.prototype.symbols, s = f.getOptions(), y; p(s.lang, { printChart: "打印", downloadPNG: "导出为PNG", downloadJPEG: "导出为JPEG", downloadPDF: "导出为PDF", downloadSVG: "导出为SVG", contextButtonTitle: "菜单" }); s.navigation = { menuStyle: { border: "1px solid #A0A0A0",
...
}; s.exporting = { type: "image/png", url: "/Hightcharts/GetImgFromHightcharts", buttons: { contextButton: { menuClassName: "highcharts-contextmenu",
