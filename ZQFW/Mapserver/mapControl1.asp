...
<body link="black" vlink="black" alink="black" onload="startup();">
<!--<div id="top">
    <div id="buttons" class="inline_table">
        <ul class="chartbutton">
            ...
            <li id="rightbutton" ><div  onclick = "createChart('pie')" >
                <img id="chartpie"src="images/button/chart_pie.gif" /></div></li>-->
<!--            <li id="rightbutton"   ><div onclick = "createChart('table')">
                <img id="maptable"src="images/button/table.png" /></div></li>-->
<!--        </ul>
    </div>   
</div>-->

<!-- content language="javascript" onload="ResizeImg(this,<% = cxmap%>,<%= cymap %>)"   -->
<form action="mapControl1.asp" method="post" id = "formMap">
    <div id="aboutMap" class="aboutMap">
        <input id="map" class="map" style="margin:0" type="image" src="<%= image %>" width="<%= cxmap %>" height="<%= cymap %>" border="0" 
		        onmouseover='createInfoWindow()' onmouseout='hideWindow()' onmousemove='showInfo(event)'/>
...
<!--        <div class="mapBottom"></div>-->
        ...
        <div id="legend" style="left:5px; "></div>
