...
App.Plugin.TableFixed = function () {
    ...
    tableFixed.Fix = function (table) {
        ...
        if (!(pageIndex == 4 || pageIndex == 5) && table.Type != "Head") {
