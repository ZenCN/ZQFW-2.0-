...
!angular.$$csp() && angular.element(document).find('head').prepend('<style type="text/css">@charset "UTF-8";[ng\\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide{display:none !important;}ng\\:form{display:block;}</style>');;Array.prototype.In_Array = function (e) {   //e可为string、number类型或等于null、undefined
    var exist = false;
    if (typeof e == "string") {
            ...
            $element.uploadify({
                ...
                'onFallback': function() {
                    ...
                    $("#fileUpload a").click(function() {
                        if ($scope.Open.Report.Current.ReportTitle.PageNO == 0 || $scope.Open.Report.Current.Attr.Data_Changed) {
