...
namespace System.Drawing.PieChart {
	...
	public class PieChart3D	: IDisposable {
        ...
        public void Draw(Graphics graphics) {
            for (int i = 0; i < m_sliceColors.Length; i++)
            {
                m_sliceColors[i] = Color.FromArgb(m_alpha, m_sliceColors[i]);
            }
        ...
        /// </summary>
        protected float         m_sliceRelativeHeight       = 0.1F;
        /// <summary>
        ...
        /// </summary>
        protected EdgeColorType m_edgeColorType = EdgeColorType.DarkerThanSurface;
        /// <summary>
        ///   Edge line width.
        /// </summary>
        ...
        ///   Shadow style.
        /// </summary>
        protected ShadowStyle   m_shadowStyle = ShadowStyle.GradualShadow;
        /// <summary>
